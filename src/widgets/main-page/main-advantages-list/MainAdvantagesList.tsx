...
const MainAdvantagesList = ({ advantagesList, title }: Props) => {
  return (
    ...
    <ul style={!title ? {paddingTop: 70} : {paddingTop: 0}} className={styles.advantages_list}>
      ...
      <li key={index} className={styles.advantages_container}>
        ...
        />
        <h2 className={styles.advantages_container__title}>{advantages.title ? advantages.title : advantages.title}</h2>
        <span className={styles.advantages_container__description}>{advantages.description ? advantages.description : ''}</span>
      </li>  
      )}
    </ul>
      </ContentContainer>
